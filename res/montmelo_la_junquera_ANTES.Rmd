...
##Analizamos ahora Montmelo-La Junquera:
...
Clara estacionariedad con tendencia decreciente el último año, aunque años anteriores se mantuvo sin tendencia ni ciclos(tren muestra tanto tendencia como ciclos).
...
Analizando los residuos: Si se ve correlación en el lag 12, la distribución de residuos no es normal y no? pasa el test de de portmanteau (creo que es 95%, entonces no lo pasa), luego los intervalos de predicción NO son fiables 
```{r}
tsdisplay(residuals(fit2))
